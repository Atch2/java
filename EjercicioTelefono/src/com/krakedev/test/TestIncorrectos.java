...
public class TestIncorrectos {
	public static void main(String[] args) {
		...
		// Segunda forma de recuperar teléfonos en estado "E"
		ArrayList<Telefono> telefonosIncorrectos2 = contacto.recuperarIncorrectos();
		System.out.println("**************" + "\nIncorrectos: " + telefonosIncorrectos.size());

...
public class TestEstudiante {
	...
	public static void main(String[] args) {
		...
		estudiante.agregarNota(nuevaNota.getCalificacion());
		// No deberia dejar ingresar esta nota ya que la calificacion esta duplicada.
		estudiante.agregarNota(nuevaNota2.getCalificacion());
		// No deberia dejar ingresar esta nota ya que la calificacion es menor a 0.
		estudiante.agregarNota(nuevaNota3.getCalificacion());
		estudiante.agregarNota(nuevaNota4.getCalificacion());
